...
class CricketScore:
    ...
    def __init__(self, rootWindow):
        ...
        self.bg = ImageTk.PhotoImage(file="test.jpg")
        bg_label = Label(self.rootWindow, image=self.bg)
        bg_label.place(x=0, y=0)

        # Adding live matches text to GUI
        self.label = Label(self.rootWindow, text='Live Matches', font=("times new roman", 60), compound='center')
        ...
        self.b1.place(x=50, y=380)

    # Command for check score button
    def select(self):
        return self.cb.get()

    # Scraping the data from cricbuzz.com
    def scrap(self):
...
def main():
    ...
    # Creating object for class CricketScore
